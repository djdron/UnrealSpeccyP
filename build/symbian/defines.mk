...
SYMBIAN_MACRO = -D__SYMBIAN32__ -D__EPOC32__ -D_SYMBIAN -DUSE_UI -DUSE_CONFIG -DUSE_ZIP -I$(SRC_PATH)/3rdparty/zlib -I$(SRC_PATH)/3rdparty/minizip -I$(SRC_PATH)/3rdparty/tinyxml
