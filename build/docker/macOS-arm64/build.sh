...
$OSXCROSS_HOST-cmake .. -G Ninja -DUSE_SDL2=1 -DUSE_SDL=0 -DCMAKE_BUILD_TYPE=Release -DCMAKE_OSX_ARCHITECTURES="arm64" -DOPENGLES2_INCLUDE_DIR=$GLES2_INCLUDE_PATH -DOPENGLES2_gl_LIBRARY=$GLES2_LIB_PATH/libGLESv2.dylib
cmake --build . -- -j 4
...
cd ../../..
ldid -S UnrealSpeccyPortable.app/Contents/MacOS/UnrealSpeccyPortable
ldid -S UnrealSpeccyPortable.app/Contents/lib/*.dylib
