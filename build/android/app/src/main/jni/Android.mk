...
LOCAL_CFLAGS	:= -D_POSIX -D_ANDROID -DUSE_EXTERN_RESOURCES -DUSE_FILE32API -DUSE_CONFIG -DUSE_ZIP -DUSE_GLES2 -DUSE_GLES2_SIMPLE_SHADER -I$(SRC_PATH)/3rdparty/minizip -I$(SRC_PATH)/3rdparty/tinyxml2
