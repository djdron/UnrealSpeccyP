...
SRC_PATH = ../../..
SRCFOLDERS = . z80 tools tools/zlib tools/tinyxml snapshot platform platform/android platform/touch_ui platform/gles2 devices devices/fdd devices/input devices/sound
ifdef _PROFILE
...
LOCAL_CFLAGS	:= -D_ANDROID -DUSE_OPTIONS_COMMON -DUSE_EXTERN_RESOURCES -DUSE_GLES2
